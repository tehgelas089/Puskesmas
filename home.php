...
<body>
  ...
  <!-- Start header Area -->
  <section id="hero-area" class="header-area header-eight" style="background-color: #1f6a4e;">
    <div class="container">
      ...
      <div class="d-flex justify-content-center align-items-start flex-wrap gap-2">
        ...
        <div class="justify-content-center my-4 flex-wrap" style="max-width: 700px; width: 100%;">
          <div class="input-group">
            ...
            <button id="btnCariMateri" class="btn text-white" style="background-color: #1f6a4e;">
              Cari
            </button>
          </div>
