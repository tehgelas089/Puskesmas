...
<body>
  ...
  <script>
    /* ===== KEY KHUSUS UNTUK LIST UTAMA ===== */
    const STORAGE_KEY_STATUS = "activitiesStatus_main";
    const STORAGE_KEY_INFO = "infoBoxContent_main";
    const STORAGE_KEY_VISIBLE = "infoBoxVisible_main";
    /* ===================================== */
